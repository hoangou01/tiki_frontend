        ...
        <Container>
            ...
            <Row>
              ...
              <Col md={3}>
                <div className="footer_aboutus">
                  <h5>Về Tiki</h5>
                  <ul className="footer_aboutus_ul">
                    <li>
                    ...
                    <li>
                      <a href="">Gửi Astra nhận Xu mua sắm thả ga</a>
                    </li>
                    <li>
              ...
              <Col md={3}>
                <div className="footer_cooperate">
                  <h5>Hợp tác và liên kết</h5>
                  <ul className="footer_cooperate_ul">
                    <li>
                ...
                <div className="footer_payment mt-2">
                  ...
                  <p className="payment">
                    ...
                    <span className="icon">
                      ...
                      >
                        <path
                          d="M28.8002 3.8665H3.2002V29.4665H28.8002V3.8665Z"
                          fill="#1093D5"
                        ></path>
                        <path
                        ...
                        ></path>
                        <path
                          d="M28.8002 29.4665H3.2002V18.1539H28.8002V29.4665Z"
                          fill="#00B14F"
                        ></path>
                        <path
                ...
                <div className="footer_shipment mt-2">
              ...
              <Col md={3}>
                <div className="footer_connectus">
                  <h5>Kết nối với chúng tôi</h5>
                  <ul className="footer_connectus_ul">
                    <li>
                      <a href="">
                        <svg
                          width="32"
          ...
          <div className="footer_address">
            ...
            <p>
              ...
              Đầu tư Thành phố Hồ Chí Minh cấp lần đầu ngày 06/01/2010 và sửa
              đổi lần thứ 23 ngày 14/02/2022
            </p>
