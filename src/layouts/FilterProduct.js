...
const FilterProduct = () => {
    ...
    useEffect(() => {
        const loadProduct = async () => {
            ...
            var is_global = q.get("is_global");
            if (is_global !== null) e += `&is_global=${is_global}`;
            setLoading(true);
                                ...
                                <div className="location_product">
                                    ...
                                    <div className="flex-column d-flex">
                                        <div className="d-flex">
                                            <Link to={`/products/?is_global=${0}`} className="text-dark">
                                                <input
                                                    type="radio"
                                        ...
                                        <div className="d-flex">
                                            <Link to={`/products/?is_global=${1}`} className="text-dark">
                                                <input
                                                    type="radio"
                                                    name="location_product"
                                                    value=""
